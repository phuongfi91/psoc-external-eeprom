...
export LoadConfigTBL_em_project_Bank1
export LoadConfigTBL_em_project_Bank0
export LoadConfigTBL_em_project_Ordered
AREA lit(rom, rel)
LoadConfigTBL_em_project_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_em_project_Bank1:
;  Instance name I2Cm, User Module I2Cm
;  Instance name LCD, User Module LCD
...
LoadConfigTBL_em_project_Ordered:
;  Ordered Global Register values
	...
	mov	reg[07h], 07h		; Port_1_IntCtrl_1 register (PRT1IC1)
	M8C_SetBank0
	mov	reg[05h], 07h		; Port_1_IntEn register (PRT1IE)
