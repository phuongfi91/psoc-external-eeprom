...
export LoadConfig_em_project
export _LoadConfig_em_project
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_DriveMode_2_SHADE], fch
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], 7fh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_em_project
	lcall	LoadConfigTBL_em_project_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration em_project
;
;    Load configuration registers for em_project.
...
;               CUR_PP
;
_LoadConfig_em_project:
 LoadConfig_em_project:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_em_project_Bank0
    mov     X, <LoadConfigTBL_em_project_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_em_project_Bank1
    mov     X, <LoadConfigTBL_em_project_Bank1
